          ...
          >
            ...
            <Card className="text-center">
              ...
              <p className="text-2xl font-bold text-blue-600">
                {favorites.length > 0
                  ? Math.round(
                      favorites.reduce((acc, r) => acc + r.prepTime, 0) / favorites.length
                    )
                  : 0}
              </p>
            ...
            <Card className="text-center">
              ...
              <p className="text-2xl font-bold text-green-600">
                {favorites.length > 0
                  ? Math.round(
                      favorites.reduce((acc, r) => acc + r.nutritionInfo.glycemicIndex, 0) /
                        favorites.length
                    )
                  : 0}
              </p>
            ...
            <Card className="text-center">
              ...
              <p className="text-2xl font-bold text-yellow-600">
                {favorites.reduce((acc, r) => acc + r.nutritionInfo.servings, 0)}
              </p>
            </Card>
          </motion.div>
        )}
        ...
        {filteredFavorites.length > 0 ? (
          ...
          <Card className="text-center py-16">
            ...
            <p className="text-neutral-600 mb-8 max-w-md mx-auto">
              Explore nossas receitas e salve suas favoritas clicando no coração.
            </p>
